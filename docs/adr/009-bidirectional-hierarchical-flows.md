...
**Relates to**: ADR-001 (CAP Protocol), ADR-004 (Human-Machine Composition), ADR-007 (Automerge Sync), ADR-008 (Network Simulation)
...
- **ADR-001 (CAP Protocol POC)**: Establishes hierarchical architecture for upward flows
