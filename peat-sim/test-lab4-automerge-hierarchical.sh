#!/bin/bash
# Lab 4-automerge: Hierarchical PEAT CRDT with AutomergeIroh Backend
#
...
RESULTS_DIR="/work/peat-sim-results/automerge-hierarchical-${TIMESTAMP}"
...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║  Lab 4-automerge: Hierarchical PEAT CRDT with AutomergeIroh ║"
...
if ls peat-hierarchical-*/peat-hierarchical-results.csv 2>/dev/null | head -1 > /dev/null; then
    DITTO_RESULTS=$(ls -t peat-hierarchical-*/peat-hierarchical-results.csv | head -1)
