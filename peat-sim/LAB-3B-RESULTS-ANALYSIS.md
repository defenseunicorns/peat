...
**Results Directory**: `peat-flat-mesh-20251123-162440/`

**Key Files**:
- `peat-flat-mesh-results.csv` - All metrics
- `logs/*.log` - Container logs with CRDT latency measurements
- `*.yaml` - ContainerLab topology files

**Code Changes**:
- `peat-sim/src/main.rs:1806-1808` - CRDT latency instrumentation
- `test-lab3b-peat-mesh.sh:72-95` - Metrics extraction
