...
### Required Setup
- ✅ **Docker Image Built** - `peat-sim-node:latest` must exist
...
docker image ls peat-sim-node  # Verify image exists
...
**Results location:**
```bash
peat-sim/e8-performance-results-latest/
```
...
### Main Summary Report
```bash
cat peat-sim/e8-performance-results-latest/E8-THREE-WAY-COMPARISON.md
```

### Architecture-Specific Summaries
```bash
# Traditional IoT results
cat peat-sim/e8-performance-results-latest/1-traditional-iot-baseline/COMPREHENSIVE_SUMMARY.md

# CAP Full Replication results
cat peat-sim/e8-performance-results-latest/2-cap-full-replication/COMPREHENSIVE_SUMMARY.md

# CAP Differential results
cat peat-sim/e8-performance-results-latest/3-cap-differential/COMPREHENSIVE_SUMMARY.md
```

### Detailed Metrics
```bash
# View metrics for specific test
cat peat-sim/e8-performance-results-latest/2-cap-full-replication/100mbps/mode1-client-server_summary.txt

# View JSON metrics
jq . peat-sim/e8-performance-results-latest/2-cap-full-replication/100mbps/mode1-client-server_metrics.json
```

### Per-Node Logs
```bash
# View logs for specific node
cat peat-sim/e8-performance-results-latest/2-cap-full-replication/100mbps/mode1-client-server_soldier-1.log
```
...
- **Detailed Optimization Plan:** `peat-sim/E8-OPTIMIZATION-PLAN.md`
- **Baseline Requirements:** `peat-sim/BASELINE-TESTING-REQUIREMENTS.md`
- **Traditional IoT Design:** `peat-sim/TRADITIONAL-BASELINE-DESIGN.md`
- **Main README:** `peat-sim/README.md`
